...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>北京时间</label><span><?php echo date('Y年m月d日 H时m分s秒')?></span>
                </li>
                <li>
                    <label>服务器域名/IP</label><span>{{$_SERVER['SERVER_NAME']}} [ 127.0.0.1 ]</span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://www.gehuachun.com</a></span>
                </li>
                <li>
