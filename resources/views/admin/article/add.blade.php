    ...
    <form action="{{url('admin/article')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>缩略图：</th>
                <td>
                    <input type="text" size="50" name="art_thumbnail">
            ...
            <tr>
                <th></th>
                <td>
                    <img src="" alt="" id="art_thumbnail_img" style="max-width: 340px;max-height: 120px">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <script id="editor" name="art_content" type="text/plain" style="width:960px;height:500px;"></script>
                    <script type="text/javascript">
